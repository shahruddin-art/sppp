...
import { formatStatus, getStatusColor, formatApplicationType, getZoneColor, formatDateTime, getRemainingTime } from '@/lib/formatters';
...
export default function ApplicationList({ onSelect }: ApplicationListProps) {
            ...
            return (
              <Card
                ...
                className={`cursor-pointer transition-all hover:shadow-md border-l-4 ${
                  app.isOverdue ? 'border-l-red-500' : app.status === 'COMPLETED' ? 'border-l-emerald-500' : 'border-l-sky-500'
                }`}
              ...
              >
                <CardContent className="p-4">
                  ...
                  {/* Current step info */}
                  {app.status !== 'COMPLETED' && currentStepData && (
                    <div className={`rounded-md p-2 mb-3 ${
                      stepOverdue ? 'bg-red-50 border border-red-200' :
                    ...
                    <div className={`rounded-md p-2 mb-3 ${
                      ...
                      <p className={`text-xs ${
                        ...
                        Keputusan: {app.plbDecision === 'SIMPAN_FAIL' ? 'Simpan Fail' :
                          ...
                          app.plbDecision === 'JABATAN_PERANCANG_BANDAR' ? 'Hantar ke J. Perancang Bandar' :
                          'Ditolak'}
                      </p>
                    </div>
                  )}
